...
const Cart = () => {
  ...
  const removeItemHandler = async (id) => {
    ...
    await axios.delete(`https://crudcrud.com/api/d24ae34d2de84f0aada52d85676fa40e/cart/${id}`)
  }
              ...
              {items.map((item) => (
                <div className='cart_body_amount'>
                  ...
                  <div className='cart_body_action'>
                    <button type='submit' onClick={removeItemHandler.bind(null, item.id)}>-</button>
